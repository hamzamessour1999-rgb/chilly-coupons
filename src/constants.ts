...
export const COUPONS: Coupon[] = [
  ...
  {
    id: '12',
    title: 'Assassins Creed Black Flag Resynced Code',
    image: 'https://i.postimg.cc/PxknPBz0/capsule-616x353.png',
    rating: 5.0,
    type: 'Free Game',
    description: 'Free Game Key PS5 XBOX PC STEAM',
    couponsLeft: 278,
    usesToday: 71,
    category: 'Discount',
    details: 'The iconic solo pirate adventure returns. Sail the Caribbean as Edward Kenway during the Golden Age of Piracy in this faithfully enhanced remake featuring stunning visuals, upgraded gameplay, and new content.',
    isStudentOnly: true
  },
  {
    id: '13',
    title: 'MECCHA CHAMELEON Game Key',
    image: 'https://i.postimg.cc/W3K0pMks/capsule-616x353-(1).png',
    rating: 5.0,
    type: 'Free Game Key',
    description: 'MECCHA CHAMELEON Free Steam PC Key',
    couponsLeft: 278,
    usesToday: 71,
    category: 'Discount',
    details: 'Paint yourself to blend in! "Meccha Chameleon" is a new-sensation hide-and-seek game where you paint your white body to mimic the stage. Spot, pose, and "artistic skill" are keys to survival. Deceive Seekers with techniques that put chameleons to shame! Supports public matches and streaming.',
    isStudentOnly: true
  },
  {
    id: '2',
  ...
  {
    id: '4',
    title: 'Grand Theft Auto VI Free Gme Code',
    image: 'https://i.postimg.cc/j5DG6Sms/poster-full-0az-iud2g3y4j-(1).png',
    rating: 4.9,
    type: 'Free Game',
    description: 'PS5 | XBox FREE Pre-Order Key',
    couponsLeft: 832,
    usesToday: 61,
    category: 'Games',
    details: 'Get Grand Theft Auto VI (GTA 6) with this game key. Redeem it on the appropriate platform to unlock the full game and experience the latest open-world adventure, missions, and gameplay features.'
  },
  {
    id: '5',
